...
import org.frv.payroll.EmployeeModelAssembler;
...
public class EmployeeController {
    ...
    ResponseEntity<?> replaceOne(@RequestBody Employee newEmployee, @PathVariable Long id) {
        ...
        return ResponseEntity.created(entityModel.getRequiredLink(IanaLinkRelations.SELF).toUri()).body(updatedEmployee);
    }
